...
def run_spc_program(smc_binary = "", network_folder="", out_path="", threshold = 4):
    random_seed = 20
    T = 1
...
if __name__ == '__main__':
    ...
    parser.add_argument("--filepath",
                        default="/home/jinzhao/jinzhao/xor_smt/data/supply_chain/fast_gen_net_save4",
                        help="the filename.")
    ...
    # extra data
    no_disaster_product = calc_no_disaster_fc_production(sn, 50)
    ...
    #     all_baselines_plans.append(saa_find_plan(sn, samples, True, 250, 1000))
    ...
    # smc_outpath = "/home/jinzhao/jinzhao/xor_smt/xor_smc/supply_chain/LOG-SPC-main"
    # smc_start_time = time.time()
    # run_spc_program(smc_binary, args.filepath, smc_outpath, 6)
    ...
    print(f"No disaster most production: {no_disaster_product}")
